...
Public Class bpkb_selesai
    ...
    Private Sub txt_no_rangka_TextChanged(sender As Object, e As EventArgs) Handles txt_no_rangka.TextChanged
        ...
        Try
            ...
            If reader.Read Then
                ...
                If reader(8).ToString = "Penyerahan STNK" Then
                    Label3.Text = "BPKB SELESAI"
    ...
    Sub ubah_data()
        ...
        Else
            Try
                MysqlConn.Open()
                Dim Query As String
                Query = "update tbl_master_stnkbpkb set No_Rangka='" & txt_no_rangka.Text & "' ,Status='" & Label3.Text & "',Tgl_BPKB_jadi='" & Format(DTPBPKB.Value, "yyyy-MM-dd  H:mm :") & "' where No_Rangka='" & txt_no_rangka.Text & "'"
                cmd = New OdbcCommand(Query, MysqlConn)
                reader = cmd.ExecuteReader
    ...
    Private Sub bpkb_selesai_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        txt_no_rangka.Focus()
        btn_simpan.Hide()
    End Sub
End Class