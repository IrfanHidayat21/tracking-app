...
Public Class TANDATERIMASTNK
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "APPAuto2000P1.TANDATERIMASTNK.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTANDATERIMASTNK
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TANDATERIMASTNK = New TANDATERIMASTNK()
        rpt.Site = Me.Site
        Return rpt
    End Function
