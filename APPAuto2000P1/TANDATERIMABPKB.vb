...
Public Class TANDATERIMABPKB
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "APPAuto2000P1.TANDATERIMABPKB.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTANDATERIMABPKB
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TANDATERIMABPKB = New TANDATERIMABPKB()
        rpt.Site = Me.Site
        Return rpt
    End Function
